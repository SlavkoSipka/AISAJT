...
export function BlogPage() {
  ...
  const content = {
    sr: {
      ...
      categories: ['Web Dizajn', 'SEO', 'Marketing', 'Trendovi', 'Case Studies'],
      posts: [
        {
          id: '1',
        ...
        {
          id: '6',
          title: 'Case Study: Kako Smo Povećali Konverziju za 300%',
          excerpt: 'Detaljna analiza projekta Kralj Residence. Šta smo uradili, zašto je radilo, i kako možete primeniti na svoj sajt...',
          author: 'AiSajt Tim',
          date: '15. Dec 2024',
          readTime: '12 min',
    ...
    en: {
      ...
      readMore: 'Read More',
      categories: ['Web Design', 'SEO', 'Marketing', 'Trends', 'Case Studies'],
      posts: [
        {
          id: '1',
        ...
        {
          id: '6',
          title: 'Case Study: How We Increased Conversion by 300%',
          excerpt: 'Detailed analysis of Kralj Residence project. What we did, why it worked, and how you can apply it to your site...',
          author: 'AiSajt Team',
          date: 'Dec 15, 2024',
          readTime: '12 min',
          category: 'Case Studies',
