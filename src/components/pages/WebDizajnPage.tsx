...
export function WebDizajnPage() {
  ...
  return (
    <div className="min-h-screen bg-white overflow-x-hidden">
      ...
      <SEOHelmet
        title={language === 'sr' 
          ? 'Web Dizajn Cena | Web Dizajn Beograd | Web Dizajn Srbija'
          : 'Web Design Price | Web Design Belgrade | Web Design Serbia'
        }
        description={language === 'sr'
          ? 'Profesionalan web dizajn po najpovoljnijoj ceni u Beogradu i Srbiji. Moderni, responzivni web dizajn prilagođen vašem brendu. Besplatna konsultacija za web dizajn projekat.'
          : 'Professional web design at the best price in Belgrade and Serbia. Modern, responsive web design tailored to your brand. Free consultation for web design project.'
        }
        keywords={language === 'sr'
          ? 'web dizajn, web dizajn cena, web dizajn beograd, web dizajn srbija, dizajn sajta, dizajn web stranice'
            ...
            <div className="max-w-7xl mx-auto">
              <div className="text-center mb-8 md:mb-16">
                ...
                <p className="text-sm md:text-lg lg:text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed px-2">
                  {language === 'sr'
                    ? 'Profesionalan web dizajn u Beogradu i Srbiji nije samo vizuelna dekoracija - to je strateško oružje koje transformiše posetioce u kupce. Naš web dizajn pristup kombinuje estetiku, funkcionalnost i SEO optimizaciju za maksimalne rezultate.'
                    : 'Professional web design in Belgrade and Serbia is not just visual decoration - it\'s a strategic weapon that transforms visitors into customers.'
                  }
                </p>
              </div>
                      ...
                      <div>
                        ...
                        <p className="text-gray-600 leading-relaxed">
                          {language === 'sr'
                            ...
                            : 'A beautiful site is meaningless if it doesn\'t convert. We design with conversion in mind from day one.'
                          }
                        </p>
                      </div>
                    </div>
                ...
                <div className="order-1 md:order-2 space-y-5 md:space-y-8">
                  <div>
                    ...
                    <p className="text-gray-600 leading-relaxed pl-13">
                      {language === 'sr'
                        ? 'Pre nego što otvorimo Figmu, razgovaramo. Ko ste vi? Šta vas čini različitim? Ko su vaši konkurenti? Ovi odgovori oblikuju svaki aspekt dizajna. Naš <Link to="/seo" className="text-pink-600 hover:text-pink-700 font-semibold underline">SEO optimizovan web dizajn</Link> počinje sa strategijom, ne sa šablonima.'
                        : 'Before we open Figma, we talk. Who are you? What makes you different? These answers shape every aspect of our <Link to="/seo" className="text-pink-600 hover:text-pink-700 font-semibold underline">SEO-optimized web design</Link>.'
                      }
                    </p>
                  </div>
                  ...
                  <div>
                    ...
                    <p className="text-sm md:text-base text-gray-600 leading-relaxed pl-10 md:pl-13">
                      {language === 'sr'
                        ...
                        : 'A beautiful site that\'s confusing is useless. We first design the user flow, then add the visual layer.'
                      }
                    </p>
                  </div>
              ...
              <div className="bg-gradient-to-br from-gray-50 to-white rounded-3xl p-8 md:p-12 border border-gray-200 relative overflow-hidden">
                ...
                <div className="relative z-10">
                  ...
                  <p className="text-center text-gray-700 leading-relaxed max-w-3xl mx-auto">
                    {language === 'sr'
                      ? 'Profesionalan web dizajn u Srbiji i Beogradu nije luksuz - to je konkurentska prednost. U digitalnom svetu gde prvi utisak traje 50 milisekundi, kvalitetan dizajn razlikuje lidere od pratilaca. Investicija u web dizajn se vraća kroz bolje konverzije, jači brend, i dugoročan rast. Saznajte više o našim <Link to="/resources" className="text-pink-600 hover:text-pink-700 font-semibold underline">resursima za web dizajn</Link>.'
                      : 'Professional web design is not a luxury - it\'s a competitive advantage. Learn more about our <Link to="/resources" className="text-pink-600 hover:text-pink-700 font-semibold underline">web design resources</Link>.'
                    }
                  </p>
                </div>
              </div>
                ...
                <div className="group bg-white rounded-xl md:rounded-2xl p-4 sm:p-6 md:p-8 border-l-4 border-pink-500 shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-x-2">
                  <div className="flex items-start gap-4 sm:gap-6">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-gray-600 leading-relaxed">
                        {language === 'sr' 
                          ? 'Razgovaramo o vašim ciljevima, ciljnoj grupi, konkurenciji, i željenom stilu. Definišemo scope projekta i cenu web dizajna.'
                          : 'We discuss your goals, target audience, competition, and desired style. We define project scope and web design price.'
                        }
                      </p>
                    </div>
                  </div>
          ...
          <div className="container mx-auto px-4 relative z-10">
            <div className="max-w-3xl mx-auto text-center">
              ...
              <p className="text-sm text-gray-500 mt-6">
                {language === 'sr' 
                  ? 'i Odgovaramo u roku od 24h. Bez obaveza.'
                  : 'i We respond within 24h. No obligations.'
                }
              </p>
            </div>
          </div>
